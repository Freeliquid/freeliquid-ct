...
contract OracleTest is DSTest {
    ...
    function mintToUni(uint256 amnt0, uint256 amnt1) public {
    ...
    function mintToUni(uint256 amnt) public {
        mintToUni(amnt, amnt);
    }
    ...
    function testBbDis() public {
        ...
        assertEq(uint256(val), uint256(2 * 10**18)); //use pool part with min value
    }
