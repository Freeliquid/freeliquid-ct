...
contract User {
    ...
    function exit(GemJoinForCurveSimple j, uint256 l) public {
...
contract CurveJoinTest is TestBase {
    GemJoinForCurveSimple join;
    GemJoinForCurveSimple joinWithRewards;
    ...
    function setUp() public {
        ...
        join = new GemJoinForCurveSimple(vat, "testilk", address(gauge), false);
    }
    ...
    function testCrvStakeUnstake() public {
        ...
        assertEqM(join.totalCollateral(), l, "tc1");
        ...
        assertTrue(gauge.popLastSender() == address(bag1));
        assertEqM(join.totalCollateral(), l+l2, "tc2");
        ...
        user1.exit(join, w);
        assertTrue(gauge.popLastSender() == address(bag1));
        assertEqM(join.totalCollateral(), l+l2-w, "tc3");
        ...
        assertEqM(join.totalCollateral(), l+l2+l22-w, "tc4");
        ...
        assertTrue(gauge.popLastSender() == address(bag1));
        assertEqM(join.totalCollateral(), l22, "tc5");
        ...
        user2.exit(join, l22);
        assertTrue(gauge.popLastSender() == address(bag2));
        assertEqM(join.totalCollateral(), 0, "tc6");

        assertEqM(lp1.balanceOf(address(user2)), l22, "14");
    }

    function implCrvRewards(GemJoinForCurveSimple _join, CurveGaugeMock _gauge, DSToken _lp,
    ...
    function implCrvRewardsPartialExit(GemJoinForCurveSimple _join, CurveGaugeMock _gauge, DSToken _lp,
                                       bool rewardValueZero) public {
