...
contract User {
    ...
    function getReward(PriceProvider provider) public returns (uint256) {
...
contract SpotMock {
    ...
    function setCode(uint256 _code) public {
        code = _code;
    }
...
contract PriceProviderTest is TestBase {
    ...
    function testPriceProviderBase() public {
        uint256 updatePeriod = 3600;
        uint256 rewardTime = 72000;
        bytes32[] memory ilks = registry.list();

        uint256 chunks = rewardTime / updatePeriod;

        uint256 reward = 100000000;
